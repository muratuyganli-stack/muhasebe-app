...
# --- 1. VERİTABANI (Ana yapı korunuyor) ---
def init_db():
...
st.markdown("""
    ...
    .dash-label { font-size: 11px; color: #64748B; font-weight: bold; text-transform: uppercase; }
    .dash-val { font-size: 20px; font-weight: 800; color: #1E3A8A; }
